...
enuc =  5.1e8 * rho9**(2.) * (x4**2.) * (t9**(-3.)) * np.exp(-4.4027/t9) # (O + Be + C + He) * (t9**(-3.)) * np.exp(-4.4027/t9)
enuc_5 = 5.1e8 * (rho9*1.e-1)**(2.) * (x4**2.) * (t9**(-3.)) * np.exp(-4.4027/t9) # (O + Be + C + He) * (t9**(-3.)) * np.exp(-4.4027/t9)
#2.06e46
